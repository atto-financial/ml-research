...
def train_logistic_model(clean_engineer_dat: pd.DataFrame, selected_features: list, target_col: str = 'ust') -> Tuple[Optional[LogisticRegression], Optional[dict]]:
    try:
                    ...
                    if result is not None:
                        ...
                        if corr_dat is not None:
                            ...
                            if selected_features:
                                model, metrics = train_logistic_model(clean_engineer_dat, selected_features)
